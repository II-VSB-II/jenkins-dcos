...
#Run setup scripts.
bash /usr/local/jenkins/bin/export-libssl.sh
bash /usr/local/jenkins/bin/dcos-account.sh
bash /usr/local/jenkins/bin/dcos-quota.sh
bash /usr/local/jenkins/bin/dcos-framework-dns-name.sh
bash /usr/local/jenkins/bin/dcos-write-known-hosts-file.sh
